...
void test_cy8c95xx_pinMode_is_input_pull_up_down_or_output()
{
...
void test_cy8c95xx_digitalRead()
{
...
void test_cy8c95xx_digitalWrite()
{
...
void test_cy8c95xx_analogRead_does_nothing()
{
...
void test_cy8c95xx_analogWrite()
{
...
int runUnityTests(void)
{
    ...
    RUN_TEST(test_cy8c95xx_pinMode_is_input_pull_up_down_or_output);
    RUN_TEST(test_cy8c95xx_digitalRead);
    RUN_TEST(test_cy8c95xx_digitalWrite);
    RUN_TEST(test_cy8c95xx_analogRead_does_nothing);
    RUN_TEST(test_cy8c95xx_analogWrite);
    UNITY_END();
    return UNITY_END();
}
