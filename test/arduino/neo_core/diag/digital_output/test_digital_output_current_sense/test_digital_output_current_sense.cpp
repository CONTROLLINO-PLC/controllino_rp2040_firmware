...
uint8_t TEST_BTS71220_DAISY_CHAIN_NUMBER;
...
void test_readCurrentSenseDO_ok()
{
    ...
    TEST_ASSERT_GREATER_OR_EQUAL(TEST_BTS71220_CURRENT_SENSE_REF_ADC * BTS71220_CURRENT_SENSE_CONVERSION_CH0_OR_CH3, readCurrentSenseDO());
    //
    enableCurrentSenseDO(1);
    bts71220_set_sense_mux(neo_bts71220, BTS71220_DCR_MUX_IS_VERIF, 1);
    TEST_ASSERT_GREATER_OR_EQUAL(TEST_BTS71220_CURRENT_SENSE_REF_ADC * BTS71220_CURRENT_SENSE_CONVERSION_CH1_OR_CH2, readCurrentSenseDO());
    //
    enableCurrentSenseDO(2);
    bts71220_set_sense_mux(neo_bts71220, BTS71220_DCR_MUX_IS_VERIF, 1);
    TEST_ASSERT_GREATER_OR_EQUAL(TEST_BTS71220_CURRENT_SENSE_REF_ADC * BTS71220_CURRENT_SENSE_CONVERSION_CH1_OR_CH2, readCurrentSenseDO());
