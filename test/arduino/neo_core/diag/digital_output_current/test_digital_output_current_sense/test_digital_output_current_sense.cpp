...
{
    enableCurrentSenseDO(0);
    bts71220_set_sense_mux(neo_bts71220, BTS71220_DCR_MUX_IS_VERIF, 0); // set verification mode to generate a fixed value in sense pin
    TEST_ASSERT_GREATER_OR_EQUAL(TEST_ANALOG_READ_ADC * BTS71220_CURRENT_SENSE_CONVERSION_RATIO_CH0_OR_CH3, readCurrentSenseDO());
    //
    enableCurrentSenseDO(1);
    bts71220_set_sense_mux(neo_bts71220, BTS71220_DCR_MUX_IS_VERIF, 0);
    TEST_ASSERT_GREATER_OR_EQUAL(TEST_ANALOG_READ_ADC * BTS71220_CURRENT_SENSE_CONVERSION_RATIO_CH1_OR_CH2, readCurrentSenseDO());
    //
    enableCurrentSenseDO(2);
    bts71220_set_sense_mux(neo_bts71220, BTS71220_DCR_MUX_IS_VERIF, 0);
    TEST_ASSERT_GREATER_OR_EQUAL(TEST_ANALOG_READ_ADC * BTS71220_CURRENT_SENSE_CONVERSION_RATIO_CH1_OR_CH2, readCurrentSenseDO());
