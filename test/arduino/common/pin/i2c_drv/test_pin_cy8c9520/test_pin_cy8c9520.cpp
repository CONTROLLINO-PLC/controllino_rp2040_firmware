...
ControllinoRp2040Pin* _PIN = new ControllinoRp2040Pin(CY8C9520_GPIO_0, ControllinoRp2040Pin::CY8C9520_PIN);
...
{
    TEST_ASSERT_EQUAL(CY8C9520_GPIO_0, _TEST_CY8C9520_ARDUINO_PIN->getPin());
