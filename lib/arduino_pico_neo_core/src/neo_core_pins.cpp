...
ControllinoNeoPin*  NEO_CORE_DI0 = new ControllinoNeoPin(6, ControllinoNeoPin::NATIVE_PIN);
ControllinoNeoPin*  NEO_CORE_DI1 = new ControllinoNeoPin(7, ControllinoNeoPin::NATIVE_PIN);
ControllinoNeoPin*  NEO_CORE_DI2 = new ControllinoNeoPin(12, ControllinoNeoPin::NATIVE_PIN);
ControllinoNeoPin*  NEO_CORE_DI3 = new ControllinoNeoPin(13, ControllinoNeoPin::NATIVE_PIN);

ControllinoNeoPin*  NEO_CORE_DO0 = new ControllinoNeoPin(14, ControllinoNeoPin::NATIVE_PIN);
ControllinoNeoPin*  NEO_CORE_DO1 = new ControllinoNeoPin(22, ControllinoNeoPin::NATIVE_PIN);
ControllinoNeoPin*  NEO_CORE_DO2 = new ControllinoNeoPin(23, ControllinoNeoPin::NATIVE_PIN);
ControllinoNeoPin*  NEO_CORE_DO3 = new ControllinoNeoPin(24, ControllinoNeoPin::NATIVE_PIN);
